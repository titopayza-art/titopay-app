...
Build `admin-console-v58`. This document covers what the Analytics module does,
...
| every other `index.html` | Asset query string `?v=admin-console-v50` → `?v=admin-console-v58`. Nothing else. |
