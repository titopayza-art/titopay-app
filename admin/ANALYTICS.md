...
Build `admin-console-v55`. This document covers what the Analytics module does,
...
| every other `index.html` | Asset query string `?v=admin-console-v50` → `?v=admin-console-v55`. Nothing else. |
