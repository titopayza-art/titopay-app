...
Build `admin-console-v56`. This document covers what the Analytics module does,
...
| every other `index.html` | Asset query string `?v=admin-console-v50` → `?v=admin-console-v56`. Nothing else. |
